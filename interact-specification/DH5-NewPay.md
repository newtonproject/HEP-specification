...
1. DH5 app calls the js function **hep.login** with basic parameters and extra parameters, such as scope, expired, memo, sign_type and signature.
...
| failure | function | callback function for failling to aquire profile|
